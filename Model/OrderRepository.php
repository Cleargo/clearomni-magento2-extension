...
use Cleargo\Clearomni\Model\ResourceModel\Order\CollectionFactory as OrderCollectionFactory;
use Magento\Framework\Exception\CouldNotSaveException;
use Cleargo\Clearomni\Api\OrderRepositoryInterface;
use Cleargo\Clearomni\Model\ResourceModel\Order as ResourceOrder;
use Magento\Framework\Reflection\DataObjectProcessor;
use Cleargo\Clearomni\Api\Data\OrderSearchResultsInterfaceFactory;
use Magento\Framework\Api\SortOrder;
use Magento\Store\Model\StoreManagerInterface;
use Cleargo\Clearomni\Api\Data\OrderInterfaceFactory;
...
class OrderRepository implements orderRepositoryInterface
{
    ...
    {
        $order = $this->orderFactory->create();
        $order->getResource()->load($order, $orderId,'magento_order_id');
        if (!$order->getId()) {
            throw new NoSuchEntityException(__('Order with id "%1" does not exist.', $orderId));
        }
        return $order;
